...
! If you have questions please contact Dmitry Pekurovsky, dmitry@sdsc.edu
      ...
      integer(C_INT) grid1,grid2,pgrid,workhost,nslices
...
! Final grid has conjugate symmetry in X dimension (0)
      call p3dfft_init_data_grid(grid2,ldims2,glob_start2,gdims2,0,pgrid,dmap2,mem_order2)


! Set up the forward transform, based on the predefined 3D transform type and grid1 and grid2. This is the planning stage, needed once as initialization.

      call p3dfft_plan_3Dtrans(trans_f,grid1,grid2,type_rcc,workhost)

! Now set up the backward transform
      call p3dfft_plan_3Dtrans(trans_b,grid2,grid1,type_ccr,workhost)
