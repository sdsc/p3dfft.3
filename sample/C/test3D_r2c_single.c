...
main(int argc,char **argv)
{
  ...
  if(myid == 0) {
    ...
    type_ids1[0] = P3DFFT_R2CFFT_S;
    type_ids1[1] = P3DFFT_CFFT_FORWARD_S;
    type_ids1[2] = P3DFFT_CFFT_FORWARD_S;

    type_ids2[0] = P3DFFT_C2RFFT_S;
    type_ids2[1] = P3DFFT_CFFT_BACKWARD_S;
    ...
    for(i=0; i < Nrep;i++) {
      t -= MPI_Wtime();
      p3dfft_exec_3Dtrans_single(trans_f,IN,OUT,0); // Forward real-to-complex 3D FFT
      t += MPI_Wtime();
