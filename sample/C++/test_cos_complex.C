...
! test and for timing the library functions. This program uses real-to-real transform (cosine) on COMPLEX data in double precision, i.e. both real and imaginary parts are subject to the same transform.
!
...
main(int argc,char **argv)
{
  ...
  //  printf("Plan rcc\n");
  transplan<complex_double,complex_double> trans_f(grid1,grid2,type_ids1,dim,0);

  //Now set up the backward transform

  transplan<complex_double,complex_double> trans_b(grid2,grid1,type_ids2,dim,0);
